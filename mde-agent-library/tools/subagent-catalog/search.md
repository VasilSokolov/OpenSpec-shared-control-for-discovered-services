---
name: search
description: "Search the mde-agent-library catalog. Use when user wants to find, discover, or browse available subagents by name, category, or capability."
---
...
| Agent | Description |
|-------|-------------|
| `categories/03-infrastructure/kubernetes-specialist.md` | Container orchestration master |
| `categories/03-infrastructure/devops-engineer.md` | CI/CD and automation expert |
...
Format each match as a table row with its local relative path.
