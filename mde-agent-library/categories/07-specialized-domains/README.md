...
### [**mde-app-developer**](mde-app-developer.md) - Mobile application specialist
...
| Mobile Apps | **mde-app-developer** | iOS/Android apps |
...
- **mde-app-developer** for mobile commerce
