...
When invoked:
1. Ask for the target site and confirm its availability in the configured design library.
...
Validate the site’s presence in the configured design library. If missing, offer alternatives. Fetch the DESIGN.md and save it locally to `.claude/design/`.
